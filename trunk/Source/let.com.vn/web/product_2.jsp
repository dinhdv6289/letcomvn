                        ...
                        <div class="navigation">
                            <div class="ddsmoothmenu" id="smoothmenu1">
                                <ul>
                                    ...
                                    <li style="z-index: 100;"><a class="toplevl" href="categoryProductList.do?method=allCategoryAndProduct" style="padding-right: 0px;"><span class="nvlinkdown">Products</span></a>
                        ...
                        <div class="shop">
                            <div class="headingcart">
                                <h3 class="colr">Products
                                    <!--                                    <span class="cufon cufon-canvas" style="width: 40px; height: 18px;"><canvas width="46" height="19" style="top: 0px; left: 0px;"></canvas><span class="cufon-alt">Shop</span></span>-->
                                </h3>
                                <!--                                <div class="cart_small">
                                                                    <p class="price colr bold">$3999.99</p>
                                                                    <a href="#">05 ITems</a>
                                                                </div>-->
                            </div>
                            <div class="clear"></div>
                            <ul class="shoplist">
                                <c:if test="${categoryList != null}">
                                    ...
                                    <% for (int j = 0; j < categoryList.size(); j++) {
                                                    CategoryDTO category = categoryList.get(j);
                                    %>
                                    ...
                                    <%
                                         ...
                                         // productBO.getAllProductByCategoryId();
                                         List<ProductDTO> productList = productBO.getAllProductByCategoryId(category.getCategoryId());
                                    ...
                                    <c:if test="${i%3 != 0}">
                                        <li>
                                            ...
                                            <a class="thumb" href="#"><img alt="" src="<%=product.getPicture()%>"/></a>
                                            <h6>
                                                <a class="colr" href="#">
                                                    Details<%=i%>
                                                </a>
                                ...
                                <!--                                <li>
                                                                    <a class="thumb" href="#"><img alt="" src="images/shop3.gif"/></a>
                                                                    <h6>
                                                                        <a class="colr" href="#">
                                                                            Details
                                                                        </a>
                                                                    </h6>
                                                                    <p>consectetuer adipiscing elit. Sed elit</p>
                                                                    <div class="clear"></div>-->
                                <!--                                    <div class="pricecart">
                                                                        <p>$399.99</p>
                                                                        <a class="cart" href="#">&nbsp;</a>
                                ...
                                <!--                                </li>-->
                                <!--                                <li class="last">
                                                                    <a class="thumb" href="#"><img alt="" src="images/shop4.gif"/></a>
                                                                    <h6>
                                                                        <a class="colr" href="#">
                                                                            Details
                                                                        </a>
