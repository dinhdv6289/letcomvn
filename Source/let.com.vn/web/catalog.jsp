                        ...
                        <div class="blog">
                            <ul class="bloglist">
                                <logic:notPresent name="productList">
                                    Not have products of this Catalog
                                </logic:notPresent>
                                <logic:present name="productList">
                                    <c:forEach var="proDatas" items="${productList}">
                                        <li>
                                            <div class="thumb">
                                                <a href="#"><img alt="" src="${proDatas.picture}" width="164px"/></a>
                                            </div>
                                            <div class="desc">
                                                <h2 class="colr">${proDatas.productName}

                                                </h2>
                                                <div class="clear"></div>
                                                <p class="text">
                                                    ${proDatas.description}
                                                </p>
                                                <a class="continue colr" href="viewProduct.do?method=viewDetail&proId=${proDatas.productId}">View details</a><br/>
                                            </div>
                                        </li>
                                    </c:forEach>
                                </logic:present>
